...
function AppContent() {
  ...
  return (
    <main
      className={`bg-(--bg-primary) transition-colors duration-300 ${isDark ? "dark-theme" : "light-theme"}`}
    >
      <ScrollProgressBar />
      {/* Nav responsive */}
      ...
      <main className="w-9/10 mx-auto mt-12 lg:max-w-[1200px]">
              ...
              <article className="brief-info-container">
                <ul>
                  ...
                  <li>
                    ...
                    <p className="md:text-xl">Studying & Working</p>
                  </li>
                  <li>
                    <h6 className="text-xl font-medium md:text-2xl">
                      EXPERIENCE
            ...
            <AnimateOnScroll direction="fromLeft" delay={0.4}>
              <article className="brief-resume-container">
                <p className="main-text">
                  ...
                  <strong>Mathematics</strong> in Oviedo. Currently working as a{" "}
                  <strong>full-stack developer</strong> and{" "}
                  <strong>AI integrations</strong> as a intern at the Fundación
        ...
        <section id="work" className="mb-80">
          <AnimateOnScroll direction="fromLeft">
            <h2 className="text-5xl font-bold mb-8 lg:text-6xl text-(--text-primary)">
              SELECTED WORK
            </h2>
          </AnimateOnScroll>

          <AnimateOnScroll direction="fromRight" delay={0.2}>
            <p className="main-text lg:w-7/10">
              A collection of some of my projects in both web development and
              AI.
            </p>
          </AnimateOnScroll>
